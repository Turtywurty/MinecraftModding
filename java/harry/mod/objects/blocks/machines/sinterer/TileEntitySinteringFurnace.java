...
public class TileEntitySinteringFurnace extends TileEntity implements IInventory, ISidedInventory, ITickable {
	...
	private EnumFacing getFacing(BlockPos pos) {
		...
		if (state.getProperties().containsKey(BlockSinteringFurnace.FACING)) {
			EnumFacing facing = state.getValue(BlockSinteringFurnace.FACING);
			return facing;
		}
		return null;
	}
