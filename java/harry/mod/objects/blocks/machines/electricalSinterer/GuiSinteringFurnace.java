...
public class GuiSinteringFurnace extends GuiContainer
{
	...
	public GuiSinteringFurnace(InventoryPlayer player, TileEntityElectricalSinteringFurnace tileentity) 
	{
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityElectricalSinteringFurnace.isBurning(tileentity))
		{
