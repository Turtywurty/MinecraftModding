...
public class BlockElectricalSinteringFurnace extends BlockBase implements ITileEntityProvider
{
	...
	{
		TileEntityElectricalSinteringFurnace tileentity = (TileEntityElectricalSinteringFurnace)worldIn.getTileEntity(pos);
