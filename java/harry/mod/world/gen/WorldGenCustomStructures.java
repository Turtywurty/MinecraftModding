...
import harry.mod.world.biome.BiomeCopper;
...
{	
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 2:
			...
			generateStructure(HOUSE, world, random, chunkX, chunkZ, 200, Blocks.BOOKSHELF, BiomeCopper.class);
		...
		case 0:
			...
			generateStructure(HOUSE, world, random, chunkX, chunkZ, 25, BlockInit.PLANKS, BiomeCopper.class);
	...
	private void generateStructure(WorldGenerator generator, World world, Random random, int chunkX, int chunkZ, int chance, Block topBlock, Class<?>...classes)
	{
		...
		int y = EventsHandler.calculateGenerationHeight(world, x, z, topBlock);
